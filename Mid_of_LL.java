//The mid function should be an iterative function and should return the mid of linked list. Also, make sure
//to not use size data member directly or indirectly (by calculating size via making a traversal). In linked list
// of odd size, mid is unambigous. In linked list of even size, consider end of first half as mid.
